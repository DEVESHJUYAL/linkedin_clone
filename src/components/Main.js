                    ...
                    <Container>
                        <ShareBox>
                            ...
                            <div>
                                ...
                                <button><img src="/images/video.png" />
                                    <span>Video</span></button>
                                <button><img src="/images/event.png" />
                                    <span>Event</span></button>
                                <button><img src="/images/article.png" />
                                    <span>Write article</span></button>
                            </div>
                        </ShareBox>
                        <Content>
                            {props.loading && <img src="./images/4.svg" />}
                            {props.articles.length > 0 &&
                                props.articles.map((article, key) => (
                                    <Article key={key}>
                                        <SharedActor>
                                            ...
                                            <button>
                                                <span><img src="/images/3dots.png" /></span>
                                            </button>
                                        </SharedActor>
                                        ...
                                        <SocialCounts>
                                            <li>
                                                <button>
                                                    <img src="./images/like.png" style={{marginRight: "5px"}} />
