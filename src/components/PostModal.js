        ...
        <>{props.showModal === "open" &&
            <Container><Content><Header>
                ...
                <button onClick={(event) => reset(event)}>
                    <img src="/images/close.png" /></button></Header>
                <SharedContent>
                    <UserInfo>
                    ...
                    <Editor><textarea placeholder="What do you want to talk about" autoFocus={true} value={editorText} onChange={(e) => setEditorText(e.target.value)} />
                        {assetArea === "image" ? (
                            < UploadImage >
